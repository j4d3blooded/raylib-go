...
*
*   This example has been created using raylib-go v0.0.0-20220104071325-2f072dc2d259 (https://github.com/j4d3blooded/raylib-go)
*   raylib-go is licensed under an unmodified zlib/libpng license (https://github.com/j4d3blooded/raylib-go/blob/master/LICENSE)
*
